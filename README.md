...
A modern, scalable real-time chat application built with React, Node.js, Socket.io, Redis, and Docker.
ConnectSphere supports one-to-one chats, group conversations, presence indicators, and persistent messaging — offering a fast, WhatsApp-like messaging experience.
